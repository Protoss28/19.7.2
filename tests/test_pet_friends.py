...
def test_add_new_pet_with_valid_data(name='Рыжик', animal_type='кот', age='4', pet_photo='rijik.jpg'):
...
def test_successful_delete_self_pet():
    ...
    # Проверяем - если список своих питомцев пустой, добавляем нового и опять запрашиваем список своих питомцев
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Петя", "Рыжик", "21", "rijik.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='Петя_2', animal_type='Рыжик_2', age=5):
...
# 1
def test_add_new_pet_simple_with_valid_data(name='Рыжик_3', animal_type='кот', age='3'):
...
def test_add_photo_to_pet_with_valid_data(pet_photo='petya.jpg'):
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet_simple(auth_key, "Рыжик_4", "кошка", "1")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_get_my_pets_with_valid_key(filter='my_pets'):
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet_simple(auth_key, 'Рыжик_5', 'кот', '8')
        _, my_pets = pf.get_list_of_pets(auth_key, filter)
...
# 12
def test_add_new_pet_with_symbols_in_name_type(name='>>#/$|?_(!]{}((~$', animal_type='[:[)%~^|?$%^$:(=%)', age='279', pet_photo='siba_inu.jpg'):
...
# 13
def test_add_new_pet_with_str_in_age(name='Догги', animal_type='слабака', age='Очень много', pet_photo='siba_inu.jpg'):
